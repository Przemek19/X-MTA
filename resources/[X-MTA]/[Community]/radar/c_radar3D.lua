...
-- window settings
local windowSize = {420 / zoom, 240 / zoom}
local blipSize = 0.5

local logoTexture = dxCreateTexture(":FILES/images/logo.png")

--windowSize = {windowSize[1] * (scy / 600) , windowSize[2] * (scy / 600)}
local windowStart = {20 / zoom, scy - windowSize[2] - 40 / zoom}
--blipSize = blipSize * (scy / 600)
local addSize = 15 * (scy / 600)
...
local renderTargetColor = tocolor(255, 255, 255, 255) -- map tiles, zones
local borderColor = tocolor(9, 132, 227)
...
addEventHandler("onClientRender", root, function()
	...
	dxDrawImage(20 / zoom + windowSize[1] - 80 / zoom, scy - 40 / zoom, 80 / zoom, 40 / zoom, logoTexture)

	dxDrawRectangle(windowStart[1] - borderSize, windowStart[2] - borderSize, borderSize, windowSize[2] + borderSize * 2, borderColor)
	dxDrawRectangle(windowStart[1] + windowSize[1], windowStart[2] - borderSize, borderSize, windowSize[2] + borderSize * 2, borderColor)

	dxDrawRectangle(windowStart[1] - borderSize, windowStart[2] - borderSize, windowSize[1] + borderSize * 2, borderSize, borderColor)
	dxDrawRectangle(windowStart[1] - borderSize, windowStart[2] + windowSize[2], windowSize[1] + borderSize * 2, borderSize, borderColor)
